                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="relative self-start sm:self-auto" ref={timeframeDropdownRef}>
                    ...
                    {timeframeDropdownOpen && (
                      <div
                        role="listbox"
                        className="absolute right-0 top-full mt-2 w-48 rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-1.5 shadow-xl shadow-slate-900/10 dark:shadow-black/40 z-30 animate-fadeIn"
                      >
                          ...
                          return (
                            <button
                              ...
                              className={`w-full flex items-center gap-2 px-2.5 py-2 rounded-xl text-xs font-medium text-left transition-colors cursor-pointer ${isSelected
                                ? "bg-blue-50/90 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 font-semibold"
                                : "text-slate-700 dark:text-slate-300 hover:bg-blue-50/60 dark:hover:bg-blue-900/20"
                                }`}
                            >
                              <span className="flex h-4 w-5 shrink-0 items-center justify-center text-blue-600 dark:text-blue-400">
                                {isSelected && (
