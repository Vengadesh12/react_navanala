...
import { UsersAuditOverviewChart } from "../../components/dashboard/UsersAuditOverviewChart";
    ...
    >
      ...
      <div className="w-full min-h-screen bg-slate-50/50 dark:bg-[#0b0f19] px-4 py-6 sm:px-8 space-y-6">
        ...
        {visibleChartCount > 0 && (
          ...
          >
            {/* Left Chart: Users & Audit Overview (Modern Premium SaaS Analytics Redesign) */}
            {matchUsersOverview && (
              <div className={visibleChartCount === 2 ? "lg:col-span-2" : "w-full"}>
                <UsersAuditOverviewChart
